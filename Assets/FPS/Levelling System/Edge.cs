...
public class Edge
{
    ...
    public void InitialiseLineRenderer(GameObject edgeCollection)
    {
        ...
        if (uiLineRenderer == null)
        {
            ...
            // Attach the UILineRenderer to the canvas directly instead of the node
            //Canvas canvas = fromNode.GetComponentInParent<Canvas>();
            //if (canvas == null)
            //{
            //    Debug.LogError("No Canvas found in the hierarchy of fromNode.");
            //    return;
            //}
            //GameObject edgeCollection = GameObject.FindGameObjectWithTag("EdgeCollection");
