...
namespace Unity.FPS.UI
{
    public class InGameMenuManager : MonoBehaviour
    {
        ...
        [Tooltip("Reference to the skill tree to prevent conflicts")]
        ...
        {
            if (!skillTreeRoot.activeSelf) // Only set the cursor if the skill tree is inactive
            {
