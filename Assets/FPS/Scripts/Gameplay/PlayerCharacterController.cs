...
namespace Unity.FPS.Gameplay
{
    ...
    public class PlayerCharacterController : MonoBehaviour
    {
        ...
        //Jibbe
        //[SerializeField]
        //private SceneTypeObject m_BlasterProjectile;
        ...
        void Start()
        {
            ...
            //Jibbe
            Events.PlayerEvent.player = this.gameObject;

            EventManager.AddListener<HPIncreasedEvent>(IncreaseHealth);
            EventManager.AddListener<SpeedIncreasedEvent>(IncreaseMovementSpeed);
            //
        }
        ...
        // Jibbe
        private void IncreaseHealth(HPIncreasedEvent evt)
        {
            m_Health.MaxHealth += evt.HPBuff;
            m_Health.CurrentHealth += evt.HPBuff; //Also add the buff to the current hp, like in Pokémon
        }

        //public void IncreaseBlasterDMG(float amount)
        //{
        //m_Health.IncreaseDamage(amount);              Gets called in the enemycontroller script
        //}

        private void IncreaseMovementSpeed(SpeedIncreasedEvent evt)
        {
            //MovementSpeedModifier += amount;

            MaxSpeedOnGround += evt.SpeedBuff;
        }

        private void OnDestroy()
        {
            EventManager.RemoveListener<HPIncreasedEvent>(IncreaseHealth);
            EventManager.RemoveListener<SpeedIncreasedEvent>(IncreaseMovementSpeed);
        }
        //
